...
const _ = require("lodash"); /* LODASH SETUP VAR = _*/
...
let postsArray = []  //TODO: Keep all post objects in here.
...
app.get("/", (req, res) => {  //* Root Page Routing
  res.render(`${__dirname}/views/home`, { contentName: homeStartingContent, posts: postsArray })
...
app.get("/posts/:postName", (req, res) => { //* Post Page Routing(Dynamic)
